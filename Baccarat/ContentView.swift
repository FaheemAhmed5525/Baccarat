...
//                            let y = geometry.frame(in: .global).origin.y
    ...
    func dealCards() {
        var playerTotal: Int = ((playerHandCard1 % 13) + (playerHandCard2 % 13)) % 10
        var bankerTotal: Int = ((bankerHandCard1 % 13) + (bankerHandCard2 % 13)) % 10
        ...
        if playerTotal == bankerTotal {
            ...
            playerTotal = ((playerHandCard1 % 13) + (playerHandCard2 % 13) + (playerHandCard3) % 13) % 10
            
        }
        let playerThirdCard = ((playerHandCard2) % 13) % 10
        ...
        bankerTotal = ((bankerHandCard1 % 13) + (bankerHandCard2 % 13) + (bankerHandCard3 % 13)) % 10
        }
